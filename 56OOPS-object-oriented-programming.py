...
# we will learn about Object Oriented Programming (OOP). The basic idea of object-oriented programming (OOP) 
# in Python is to use classes and objects to represent real-world concepts and entities.
...
# One of the key features of OOP in Python is encapsulation, which means that the internal state of an object is hidden and can only be 
# accessed or modified through the object's methods. This helps to protect the object's data and prevent it from being modified in unexpected ways.
...
# In summary, OOP in Python allows developers to model real-world concepts and entities using classes and objects, encapsulate data, reuse code through 
